...
enum HIDKeyboard {
  ...
  static func hidKeycode(macKeyCode: UInt16) -> UInt8? {
    ...
    case kVK_Return: return 0x28; case kVK_Escape: return 0x29; case kVK_Delete: return 0x2A; case kVK_Tab: return 0x2B; case kVK_Space: return 0x2C
    case kVK_ANSI_Minus: return 0x2D; case kVK_ANSI_Equal: return 0x2E; case kVK_ANSI_LeftBracket: return 0x2F; case kVK_ANSI_RightBracket: return 0x30
    case kVK_ANSI_Backslash: return 0x31; case kVK_ANSI_Semicolon: return 0x33; case kVK_ANSI_Quote: return 0x34; case kVK_ANSI_Grave: return 0x35
  ...
  static func hidKeycode(ascii char: Character) -> UInt8? {
    ...
    switch a { case 0x61...0x7A: return a - 0x61 + 0x04; case 0x41...0x5A: return a - 0x41 + 0x04; case 0x31...0x39: return a - 0x31 + 0x1E; case 0x30: return 0x27; case 0x20: return 0x2C; case 0x0A, 0x0D: return 0x28; case 0x09: return 0x2B; case 0x2D: return 0x2D; case 0x3D: return 0x2E; case 0x5B: return 0x2F; case 0x5D: return 0x30; case 0x5C: return 0x31; case 0x3B: return 0x33; case 0x27: return 0x34; case 0x60: return 0x35; case 0x2C: return 0x36; case 0x2E: return 0x37; case 0x2F: return 0x38; default: return nil }
  }
