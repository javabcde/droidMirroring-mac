...
enum HIDKeyboard {
  static let descriptor: Data = Data([
    ...
    0x95, 0x05, 0x75, 0x01, 0x05, 0x08, 0x19, 0x01, 0x29, 0x05, 0x91, 0x02, 0x95, 0x01, 0x75, 0x03, 0x91, 0x01, 0xC0
  ])
  ...
  static func hidKeycode(macKeyCode: UInt16) -> UInt8? {
    ...
    case kVK_Tab: return 0x2B; case kVK_Space: return 0x2C; case kVK_ANSI_Minus: return 0x2D; case kVK_ANSI_Equal: return 0x2E
    case kVK_ANSI_LeftBracket: return 0x2F; case kVK_ANSI_RightBracket: return 0x30; case kVK_ANSI_Backslash: return 0x31
    case kVK_ANSI_Semicolon: return 0x33; case kVK_ANSI_Quote: return 0x34; case kVK_ANSI_Grave: return 0x35
    case kVK_ANSI_Comma: return 0x36; case kVK_ANSI_Period: return 0x37; case kVK_ANSI_Slash: return 0x38; case kVK_CapsLock: return 0x39
    ...
    case kVK_ForwardDelete: return 0x4C; case kVK_RightArrow: return 0x4F; case kVK_LeftArrow: return 0x50
  ...
  static func hidKeycode(ascii char: Character) -> UInt8? {
    guard let a = char.asciiValue else { return nil }
    switch a {
    case 0x61...0x7A: return a - 0x61 + 0x04; case 0x41...0x5A: return a - 0x41 + 0x04
    case 0x31...0x39: return a - 0x31 + 0x1E; case 0x30: return 0x27; case 0x20: return 0x2C
    case 0x0A, 0x0D: return 0x28; case 0x09: return 0x2B; case 0x2D: return 0x2D; case 0x3D: return 0x2E
    case 0x5B: return 0x2F; case 0x5D: return 0x30; case 0x5C: return 0x31; case 0x3B: return 0x33
    case 0x27: return 0x34; case 0x60: return 0x35; case 0x2C: return 0x36; case 0x2E: return 0x37; case 0x2F: return 0x38
    default: return nil
    }
  }

  static func makeReport(modifiers: UInt8, keycodes: [UInt8]) -> Data { var r = Data(count: 8); r[0] = modifiers; for i in 0..<min(keycodes.count, 6) { r[2 + i] = keycodes[i] }; return r }
}
...
final class UHIDKeyboardManager {
  ...
  func sendKey(_ keycode: UInt8) {
    var r = Data(count: 8); r[0] = activeModifiers; r[2] = keycode
    sink(ControlMessage.uhidInput(id: deviceId, data: r))
    r[2] = 0; sink(ControlMessage.uhidInput(id: deviceId, data: r))
  }
